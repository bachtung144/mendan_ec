                            ...
                            <div class="register-form form-item ">
                                ...
                                <form class="form-stl" action="{{ route('register') }}" name="frm-login" method="POST" >
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <input type="text" id="frm-reg-lname" name="name" placeholder="Type your name" required autofocus autocomplete="name" :value="name">
                                    </fieldset>
                                    <fieldset class="wrap-input">
                                        <label for="frm-reg-email">Email *</label>
                                        <input type="email" id="frm-reg-email" name="email" placeholder="Type your email address" :value="email">
                                    </fieldset>
                                    <fieldset class="wrap-title">

        ...
        <div class="row">
            <div class="col-md-12">
                <div id="review_form_wrapper">
                    <div id="comments">
                        <h2 class="woocommerce-Reviews-title">Add review for <strong>{{ $orderProduct->name }}</strong></h2>
                        <ol class="commentlist">
                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                <div id="comment-20" class="comment_container">
                                    <img alt="" src="{{ asset('bower_components/bower_ec/assets/images/products') }}/{{ $orderProduct->images->get(0)->name }}" height="80" width="80">
                                </div>
                            </li>
                        </ol>
                    </div><!-- #comments -->
                        ...
                        <div id="respond" class="comment-respond">
                            <form wire:submit.prevent="addReview" id="commentform" class="comment-form">
                                ...
                                <p class="form-submit">
                                    ...
                                    <a href="{{ route('product.details', $orderProduct->slug) }}" class="btn btn-success pull-right">See reviews</a>
                                </p>
                            </form>
